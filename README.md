...
- HTML5 / CSS3 pur (pas de framework)
- JavaScript vanilla (animations, lightbox, filtres)
- Font Awesome (icônes)
...
```
.
├── index.html              # Site complet (une seule page)
├── assets/
│   ├── photo.jpeg
...
- Email : b.kouassi@hestim.ma
- WhatsApp : +212 660-695184
- LinkedIn : Richard Koffi

---

© 2026 KOFFI Brou Kouassi Richard
